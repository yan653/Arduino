...
byte gateway[] = { 192, 168, 2, 100 };                   // internet access via router
      ...
      if (client.available()) {
        ...
        if (readString.length() < 100) {
         ...
         if (c == '\n') {          
           ...
           client.println("</HEAD>");
           client.println("<BODY>");
           client.println("<H1>Arduino Dengan Ethernet Shield</H1>");
           client.println("<hr />");
           client.println("<br />");  
           client.println("<H2>Arduino with Ethernet Shield</H2>");
           client.println("<br />");  
           client.println("<a href=\"/?button1on\"\">On LED</a>");
           client.println("<a href=\"/?button1off\"\">Off LED</a><br />");   
           client.println("<br />");     
           client.println("<br />"); 
